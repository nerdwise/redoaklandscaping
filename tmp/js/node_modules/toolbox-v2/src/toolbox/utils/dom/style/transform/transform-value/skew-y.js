...
var SkewY = (function (_super) {
    ...
    SkewY.fromStyleString = function (value) {
        return new (SkewY.bind.apply(SkewY, [void 0].concat(flatten(TransformValueBase.styleStringToValues(value)
    ...
    SkewY.getDefaultValue = function () {
        return new (SkewY.bind.apply(SkewY, [void 0].concat(generateFilledArray(SkewY.valuesLength, function () { return 0; }))))();
    };
